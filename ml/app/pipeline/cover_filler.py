"""Fill front/back covers of a photobook template (async)."""
import logging
...
async def _fill_single_cover(
    ...
    if api_key and model:
        text = await generate_cover_caption(
